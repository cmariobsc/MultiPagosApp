 ...
 */
try{
    $servicioId = isset_get("id");
    if($servicioId)
    {
        $modelo = EmpServicios::find($servicioId);
        ...
        if($modelo)
        {
            ...
            {
                $_SESSION['mensajeSistema'] = "Fue imposible borrar el servicio seleccionado";
                header("Location:" . E_URL . E_VIEW);
                exit();
            }
        }
        ...
        {
            $_SESSION['mensajeSistema'] = "El servicio seleccionado no existe";
            header("Location:" . E_URL . E_VIEW);
            exit();
        }
    }
